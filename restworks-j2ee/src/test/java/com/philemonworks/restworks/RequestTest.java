...
import com.philemonworks.restworks.command.MockHttpRequest;
import com.philemonworks.restworks.command.MockHttpResponse;
...
public class RequestTest extends TestCase {
	public void testSpec(){
		...
		RestInvocation ri = new RestInvocation(mockHttpRequest, mockHttpResponse);
